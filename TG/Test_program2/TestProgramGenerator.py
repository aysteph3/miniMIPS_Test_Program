...
out.write(";........co_processor registers........;\n")
out.write(" lui $%s, %d\n" % (result_address, 1))
...
#template for dedicated_control data
out.write(";..........dedicated_control test..........;\n")
out.write(" lui $%s, %d\n" % (result_address, 1))
out.write(" ori $%s, $%s, %d\n\n" % (result_address, result_address, 10000))
dedicated_control.make_dedicated_control_template(parameter,out, result_register)
...
#out.write(" lui $%s, %d\n" % (result_address, 1))
#out.write(" ori $%s, $%s, %d\n\n" % (result_address, result_address, 20000))
